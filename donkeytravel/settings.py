"""
Django settings for donkeytravel project.
...
SECRET_KEY = 'django-insecure-6k*4d8n3m3a%-x8ms!z+sa19qt#xg=$iwqr12u2mkdl9*$-orr'
...
MIDDLEWARE = [
    ...
    'donkeytravel.middleware.authmiddleware.AuthMiddleware',
]

ROOT_URLCONF = 'donkeytravel.urls'
...
WSGI_APPLICATION = 'donkeytravel.wsgi.application'
